...
.nav-item a { text-decoration: none; color: var(--color-text-secondary); font-weight: 600; font-size: 14px; cursor: pointer; padding: 16px 0; display: inline-block; transition: color 0.2s; }
.nav-item a:hover { color: var(--color-primary); }
.active-nav { position: absolute; height: 3px; background: var(--color-primary); border-radius: 2px; left: 0; bottom: -8px; width: 100%; }
