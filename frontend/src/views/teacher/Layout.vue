...
.nav-links { flex: 1; display: flex; justify-content: center; align-items: center; position: relative; height: 100%; }
.nav-item { padding: 0 24px; height: 100%; display: flex; align-items: center; cursor: pointer; color: var(--color-text-secondary); transition: color 0.2s; user-select: none; }
